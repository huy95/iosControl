...
class PinkerViewVC: UIViewController {
    // Khai báo 3 control
...
extension PinkerViewVC: UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView {
        ...
        label.layer.backgroundColor = UIColor(named: color.hex)?.cgColor
        return label
    }
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        if pickerView == colorPickerView {
            ...
            label.textColor = UIColor(named: colors[row].hex)
        }
    }
